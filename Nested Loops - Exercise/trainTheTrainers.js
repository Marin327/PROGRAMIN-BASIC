function solve(input) {
  ...
  let n = Number(input[0]); // броя на хората в журито
  let namePresentation = input[1]; // име на презентации

  let index = 2; //вече са прочетени 2 елемента

  let presentationCounter = 0; // началните презентаций 
  let totalGrades = 0; // началната оценка
